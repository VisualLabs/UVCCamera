...
public final class USBMonitor {
	...
	public synchronized void register() throws IllegalStateException {
		...
		if (mPermissionIntent == null) {
			...
			if (context != null) {
				mPermissionIntent = PendingIntent.getBroadcast(context, 0, new Intent(ACTION_USB_PERMISSION), PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_IMMUTABLE);
